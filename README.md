...
**I plan to apply Clean Coding Principles to improve the health of the code and to improve the reliability of code by increasing the coverage of automated unit tests.**
