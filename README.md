...
During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)**I plan to apply Clean Coding Principles to improve the health of the code and to improve the reliability of code by increasing the coverage of automated unit tests.**
